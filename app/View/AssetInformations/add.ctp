...
<?php echo $this->Form->create('AssetInformation'); ?>
    ...
    <fieldset>
        ...
        <div class="col-lg-2">
          <label class="control-label right">พิกัด GPS: </label>
            ...
            <div class="col-lg-4">
                <?php echo $this->Form->input('asset_info_gps_coordinate',
                                array('onkeypress'=>'validate(event)',
                                'label'=>FALSE,'maxlength'=>'30', 
				'wrap'=>'input-group',
				'afterInput'=>'<span class="input-group-btn">'
                               .'<button type="button" data-toggle="modal" data-target="#myMapModal" class="btn btn-default" 
                                 style="padding-bottom: 7px;"><span class="glyphicon glyphicon-globe"></span></button></span>')); ?>
            </div>
        </div>
    ...
    <div class="col-lg-2"></div>
        ...
        <?php echo $this->Form->button(__('บันทึก'),array('type'=>'submit','class'=>'btn btn-primary btn-form','style'=>'margin-left: -10px;')); ?>
