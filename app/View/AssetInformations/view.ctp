...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Asset Information'), array('action' => 'edit', $assetInformation['AssetInformation']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Asset Information'), array('action' => 'delete', $assetInformation['AssetInformation']['id']), array(), __('Are you sure you want to delete # %s?', $assetInformation['AssetInformation']['id'])); ?> </li>
