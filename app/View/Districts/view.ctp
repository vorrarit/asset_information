...
<h2><?php echo __('District'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($district['District']['created_by']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($district['District']['modified_by']); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<?php if (!empty($district['AssetInformation'])): ?>
	...
	<?php foreach ($district['AssetInformation'] as $assetInformation): ?>
		<tr>
