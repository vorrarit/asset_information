...
<h2><?php echo __('Utilization'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Utilization Name'); ?></dt>
		<dd>
			<?php echo h($utilization['Utilization']['utilization_name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created By'); ?></dt>
		<dd>
			<?php echo h($utilization['Utilization']['created_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($utilization['Utilization']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified By'); ?></dt>
		<dd>
			<?php echo h($utilization['Utilization']['modified_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($utilization['Utilization']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Utilization'), array('action' => 'delete', $utilization['Utilization']['id']), array(), __('Are you sure you want to delete # %s?', $utilization['Utilization']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($utilization['AssetInformation'])): ?>
	...
	<?php foreach ($utilization['AssetInformation'] as $assetInformation): ?>
		<tr>
